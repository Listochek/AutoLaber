...
def run_ansambl(key_words: list, main_dirr: str, max_pic: int = 2, folders_for_saving: list = ['train', 'validation', 'test'], crawl_mode='Google',remove_duplicates: bool = True):
